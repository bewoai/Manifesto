# Balon Uçuş Planlama & Manifesto Sistemi — Proje Brief'i (Codex başlangıç)

> Codex proje belleği. Prose Türkçe, kod/değişken/alan adları İngilizce.
...
- **Vision sağlayıcı → Codex** (en güncel vision modeli). Model SADECE MRZ satırlarını OCR
...
### Sıradaki (yapılmadı)
- Vision LLM çağrısı: görsel → MRZ satırları → parser (Codex).
